 ...
 */
function bindFakeProbe($app, bool $loaded = true, ?string $version = '0.3.6', ?string $brokerError = null, ?RuntimeException $canaryError = null): void
{
